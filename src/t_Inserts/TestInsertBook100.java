 ...
 *
 */
public class TestInsertBook100 extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext jsc) {
        ...
        inserts.forEach((iterator) -> {
            ...
            try {
                ...
                Logger.getLogger(TestInsertBook100.class.getName()).log(Level.SEVERE, null, ex);
            }
