 ...
 *
 */
public class TestInsertBook500 extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext jsc) {
        ...
        inserts.forEach((iterator) -> {
            ...
            try {
                ...
                Logger.getLogger(TestInsertBook500.class.getName()).log(Level.SEVERE, null, ex);
            }
