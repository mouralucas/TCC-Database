 ...
 *
 */
public class TestInsertMovie500 extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext jsc) {
        ...
        inserts.forEach((iteration) -> {
            ...
            try {
                ...
                Logger.getLogger(TestInsertMovie500.class.getName()).log(Level.SEVERE, null, ex);
            }
