 ...
 *
 */
public class TestInsertBook50 extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext jsc) {
        ...
        inserts.forEach((iterator) -> {
            ...
            try {
                ...
                Logger.getLogger(TestInsertBook50.class.getName()).log(Level.SEVERE, null, ex);
            }
