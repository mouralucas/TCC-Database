 ...
 *
 */
public class TestInsertMovie75 extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext jsc) {
        ...
        inserts.forEach((iteration) -> {
            ...
            try {
                ...
                Logger.getLogger(TestInsertMovie75.class.getName()).log(Level.SEVERE, null, ex);
            }
