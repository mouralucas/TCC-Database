 ...
 *
 */
public class TestInsertMovie50 extends AbstractJavaSamplerClient implements Serializable {
    boolean con = Connection.setCon();
    OpenTestFiles openTestFiles = new OpenTestFiles();
    SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");

    private final String testSize = "50";
    ...
    public SampleResult runTest(JavaSamplerContext jsc) {
        ...
        inserts.forEach((iteration) -> {
            ...
            try {
                ...
                Logger.getLogger(TestInsertMovie50.class.getName()).log(Level.SEVERE, null, ex);
            }
