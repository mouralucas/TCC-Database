 ...
 *
 */
public class TestInsertBook50000 extends AbstractJavaSamplerClient implements Serializable {

    private boolean conn = Connection.setCon();
    OpenTestFiles openTestFiles = new OpenTestFiles();
    SimpleDateFormat dateFormat = new SimpleDateFormat("dd/MM/yyyy");

    private final String testSize = "50000";
    ...
    public SampleResult runTest(JavaSamplerContext jsc) {
        ...
        inserts.forEach((iterator) -> {
            ...
            try {
                ...
                Logger.getLogger(TestInsertBook50000.class.getName()).log(Level.SEVERE, null, ex);
            }
