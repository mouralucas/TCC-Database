 ...
 *
 */
public class TestInsertMovie extends AbstractJavaSamplerClient implements Serializable {
    ...
    public void testMethod() {
        SampleResult result = new SampleResult();
        inserts = openTestFiles.open("movies", "10");
        ...
        inserts.forEach((iteration) -> {
            ...
            try {
                ...
                Logger.getLogger(TestInsertMovie.class.getName()).log(Level.SEVERE, null, ex);
            }
