 ...
 *
 */
public class TestInsertMovie25 extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext jsc) {
        ...
        inserts.forEach((iteration) -> {
            ...
            try {
                ...
                Logger.getLogger(TestInsertMovie25.class.getName()).log(Level.SEVERE, null, ex);
            }
