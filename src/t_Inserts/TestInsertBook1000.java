 ...
 *
 */
public class TestInsertBook1000 extends AbstractJavaSamplerClient implements Serializable {
    ...
    public SampleResult runTest(JavaSamplerContext jsc) {
        ...
        inserts.forEach((iterator) -> {
            ...
            try {
                ...
                Logger.getLogger(TestInsertBook1000.class.getName()).log(Level.SEVERE, null, ex);
            }
